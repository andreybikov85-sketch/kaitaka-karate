...
export class Character {
  ...
  // Есть ли скелет. Модель без него не умеет двигаться — это статуя,
  // и в игру её пускать нельзя: боец замрёт и поедет по татами целиком.
  get rigged(){
    let n = 0;
    this.root.traverse(o => { if(o.isBone) n++; });
    return n > 0;
  }
