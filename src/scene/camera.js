...
// Вид сбоку: видно и глубину (камера сверху), и силуэты ударов (камера сбоку).
const SIDE  = new THREE.Vector3(0, 5.5, 11);
// Вид из-за спины: камера позади по X, потому что зал вытянут вдоль X
// и в этом виде он превращается в уходящий вдаль коридор.
const THIRD = new THREE.Vector3(-6.8, 3.1, 0);
